...
| Document | Project file switcher | Open a local project with multiple Markdown files, then click `document-project-files-trigger` | `document-project-files-menu`, `document-project-file-*-md` | Capture the active file checkmark, nested relative paths, and scroll behavior for longer project lists. |
