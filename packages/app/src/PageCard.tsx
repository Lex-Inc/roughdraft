...
const RichTextEditorSurface = memo(function RichTextEditorSurface({
  ...
  const contentCardClass =
    "rounded-[0.75rem] border border-[var(--rd-border)] bg-[var(--rd-editor-background)] shadow-[var(--rd-shadow)]";
  const documentShellClass = cn(
    "document-page-shell",
    layout === "embedded-demo"
      ? "document-page-shell-embedded grid grid-cols-1 gap-3 p-4 min-[900px]:grid-cols-[minmax(0,min(100%,42rem))_minmax(13rem,16rem)] min-[900px]:items-start min-[900px]:justify-start"
      : "flex flex-col gap-6 min-[1100px]:grid min-[1100px]:items-start min-[1100px]:justify-between min-[1100px]:gap-8",
  ...
  const documentMainClass = cn(
    ...
    layout === "embedded-demo" && "max-w-none",
  );
    ...
    <div className="cursor-text bg-transparent" data-testid="page-card-code">
      <div data-testid="document-page-shell" className={documentShellClass}>
        <div className={documentMainClass}>
          <div className={contentInsetClass}>
            <div
              className="min-h-[calc(70vh+4rem)] rounded-[0.75rem] border border-[var(--rd-border)] bg-[var(--rd-editor-background)] py-10 pr-6 pl-5 shadow-[var(--rd-shadow)] sm:py-14 sm:pr-10 sm:pl-8"
              data-testid="document-content-card"
            >
              <MarkdownCodeEditor
